...
1) django (Framework)
2) asgiref (Library)
3) django-environ (Library)
4) django-heroku (Library)
5) idna (Library)
6) python-dateutil (Library)
7) requests (Library)
8) tzdata (Library)
9) urllib3 (Library)
10) waitress (Library)
11) whitenoise (Library)
...
2) Plotly.js (JS Library)
3) jQuery (JS Library)
4) Propper.js (JS Library)
5) Font-Awesome (Icon Library & Toolkit)
